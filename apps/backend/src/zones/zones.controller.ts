...
export class ZonesController {
  ...
  // Space_Manager AND Member can both view zones (Members need to see zones to book within them)
  @UseGuards(RbacGuard)
  ...
  // Only Space_Manager can CREATE zones — per "Manage own space's zones/desks" in RBAC table
  @UseGuards(RbacGuard)
