...
export default function BillingPage() {
  ...
  // Billing is Stripe Connect onboarding — a Space Manager concern.
  // A Member's payment status per booking already lives on the
  // Bookings page (there's no separate "billing" of their own to
  // manage), so there's no nav link here for MEMBER; this fallback
  // only covers someone landing on the URL directly.
  return (
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 text-center">
          ...
          <p className="text-sm text-slate-500">
            {role === 'MEMBER'
              ? 'Payments are handled automatically when you book — check the Bookings page for status.'
